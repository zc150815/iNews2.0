...
//    picView.backgroundColor = [UIColor purpleColor];
...
-(void)setModel:(INNewsListModel *)model{
    ...
    if (imageArr.count <3) {//双图
        ...
        for (NSInteger i=0; i<2; i++) {
            ...
            [picView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",((INNewsListModel*)imageArr[i]).url]] placeholderImage:[UIImage imageNamed:@"placeholder"]];
        ...
        for (NSInteger i=0; i<3; i++) {
            ...
            [picView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",((INNewsListModel*)imageArr[i]).url]] placeholderImage:[UIImage imageNamed:@"placeholder"] options:SDWebImageDelayPlaceholder];
            [self.picView addSubview:picView];
        }
        self.typeBtn.hidden = NO;
        [self.typeBtn setTitle:[NSString stringWithFormat:@"%ld photos",imageArr.count] forState:UIControlStateNormal];
