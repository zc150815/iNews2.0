...
-(void)setModel:(INNewsListModel *)model{
    ...
    [_liveView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",((INNewsListModel*)imageArr.firstObject).url]] placeholderImage:[UIImage imageNamed:@"placeholder"] options:SDWebImageLowPriority];
