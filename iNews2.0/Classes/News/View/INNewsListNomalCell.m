...
-(void)setModel:(INNewsListModel *)model{
    ...
    if (imageArr.count) {
        ...
        [self.smallImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.url]] placeholderImage:[UIImage imageNamed:@"placeholder"] options:SDWebImageDelayPlaceholder];
    }else{
        _hasPic = NO;
    }
